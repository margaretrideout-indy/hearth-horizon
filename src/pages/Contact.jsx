              ...
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
                  <div className="flex items-center gap-6">
                    <div className="p-4 rounded-2xl bg-white/5 border border-white/5 group-hover:bg-teal-500/10">
                      {tool.icon}
                    </div>
                    <div>
                      ...
                      <h3 className="text-xl font-serif italic font-black text-white group-hover:text-teal-400">
                          {tool.title}
                      </h3>
                ...
                <div className="bg-[#110E16]/50 border-x border-b border-teal-500/30 rounded-b-[2.5rem] p-8 pt-4 animate-in slide-in-from-top-4">
                    ...
                    <div className="space-y-10">
                      <div className="relative p-10 bg-teal-500/5 border border-teal-500/20 rounded-[2.5rem]">
                        <div className="flex items-center gap-3 mb-4 text-teal-400">
                            <Compass size={20} />
                            <h4 className="text-[10px] font-black uppercase tracking-widest">Horizon Workshop</h4>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <button onClick={() => window.open("https://drive.google.com/file/d/1_OchgdOvWFJ6vBWanoSNwSiwUvo6-dmp/view", "_blank")} className="px-8 h-14 bg-white/5 border border-white/10 text-white text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-white/10 transition-all">Download Worksheet</button>
                        </div>
                      </div>
                  ...
                  {tool.id === 'verbs' && (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      {powerVerbs.map((v, i) => (
                        <div key={i} className="bg-black/40 border border-white/5 p-5 rounded-2xl hover:border-teal-500/30 transition-all">
