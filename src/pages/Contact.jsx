...
const Contact = ({ vault, isAdmin: propIsAdmin }) => {
  ...
  const handleCardClick = (tool) => {
    const isAllowed = tool.id === 'verbs' || tool.id === 'market' || 
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          {!isAllowed && <Badge className="bg-purple-500/10 text-purple-500 border border-purple-500/10 flex gap-1"><Crown size={10}/> {tool.tier}</Badge>}
                        </div>
