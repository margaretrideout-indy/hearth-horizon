...
import { 
  Trees, Search, MapPin, Briefcase, 
  ChevronRight, Filter, Zap, Globe, 
  BarChart3, ArrowUpRight, Anchor 
} from 'lucide-react';
...
export default function Canopy() {
  ...
  const [selectedHub, setSelectedHub] = useState('Remote (Canada)');
      ...
      <Card className="p-4 bg-[#2D2438]/40 border-white/10 backdrop-blur-md shadow-2xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="relative md:col-span-2">
            ...
            <Input 
              placeholder="Search by role or skill (e.g. Project Management)..." 
          ...
          <Button className="bg-teal-600 hover:bg-teal-500 text-white font-bold transition-all transform hover:scale-[1.02] active:scale-95">
            Refine Search
          </Button>
        </div>
      </Card>
