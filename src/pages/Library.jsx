...
const StandingModal = ({ isOpen, onClose, type }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
      ...
      <div className={`relative w-full max-w-lg bg-[#1a1625] border ${isSteward ? 'border-purple-500/30' : 'border-teal-500/30'} rounded-[2.5rem] p-8 md:p-12 shadow-2xl animate-in zoom-in-95 duration-200 overflow-hidden`}>
    ...
    <div className="min-h-screen bg-[#0A080D] text-zinc-300 p-4 sm:p-6 md:p-12 font-sans selection:bg-teal-500/30 overflow-x-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <header className="mb-12 md:mb-16 flex flex-col md:flex-row justify-between items-start md:items-end gap-8 border-b border-white/5 pb-10">
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl md:text-3xl font-serif italic text-white tracking-tight leading-none">
                The Library: {currentVolume === 1 ? 'Volume I' : 'Volume II'}
              </h1>
            </div>
            <p className="max-w-xl text-[11px] md:text-xs leading-relaxed text-zinc-400 font-light italic uppercase tracking-wider">
              {currentVolume === 1 
          ...
          <div className="animate-in fade-in duration-700">
            <section className="mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-[#16121D] border border-zinc-800/50 p-8 rounded-[2.5rem] hover:border-purple-500/30 transition-all flex flex-col shadow-xl">
                  ...
                  <p className="text-[12px] text-zinc-400 italic mb-8 font-light leading-relaxed">A guided PDF roadmap for recovering your energy and finding equilibrium.</p>
                ...
                <div className="bg-[#16121D] border border-zinc-800/50 p-8 rounded-[2.5rem] hover:border-purple-500/30 transition-all flex flex-col shadow-xl">
                  ...
                  <h4 className="text-xl text-white font-serif font-black italic mb-3">Your Inner Advocate</h4>
            ...
            <section className="mb-16">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                <div className="lg:col-span-1 space-y-3">
                  <button onClick={() => setStudyTab('amazon')} className={`w-full p-6 rounded-2xl border text-left transition-all ${studyTab === 'amazon' ? 'bg-teal-500/10 border-teal-500/50 shadow-lg scale-[1.02]' : 'bg-[#16121D] border-zinc-800 opacity-60'}`}>
                  ...
                  <button onClick={() => setStudyTab('reading')} className={`w-full p-6 rounded-2xl border text-left transition-all ${studyTab === 'reading' ? 'bg-teal-500/10 border-teal-500/50 shadow-lg scale-[1.02]' : 'bg-[#16121D] border-zinc-800 opacity-60'}`}>
                ...
                <div className="lg:col-span-3 bg-[#110E16] border border-zinc-800/50 p-8 md:p-14 rounded-[3rem] shadow-2xl relative overflow-hidden">
                   <div className="relative z-10">
                      {studyTab === 'amazon' ? (
                        <div className="animate-in fade-in slide-in-from-bottom-2 duration-500">
                          <h4 className="text-3xl text-white font-serif italic mb-4">The Wayfarer’s Provisions</h4>
                          <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest mb-6 italic opacity-80">
                            As an Amazon Associate I earn from qualifying purchases.
                          </p>
                          <p className="text-base text-zinc-400 font-light leading-relaxed mb-12 max-w-2xl">
                          ...
                          <a href={AMZ_PROVISIONS_URL} target="_blank" rel="noopener noreferrer" 
                             className="inline-flex items-center justify-center px-12 h-16 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] transition-all bg-teal-500 text-black hover:bg-teal-400 hover:scale-[1.02] active:scale-95 shadow-lg shadow-teal-500/20">
                            BROWSE THE COLLECTIONS <ExternalLink className="ml-2 w-4 h-4" />
                          </a>
                        </div>
                      ) : (
                        <div className="animate-in fade-in slide-in-from-bottom-2 duration-500">
                          <div className="flex flex-col md:flex-row md:items-start justify-between gap-8 mb-12">
                            ...
                            <Badge className="bg-purple-500/10 text-purple-400 border border-purple-500/20 h-fit lowercase py-1.5 px-5">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {/* Indigo - Coming Soon */}
                            <div className="p-10 rounded-[2.5rem] bg-[#1a1625] border border-white/5 flex flex-col gap-6 group relative overflow-hidden shadow-xl">
                              <div className="flex justify-between items-start">
                                <span className="text-[11px] font-black text-teal-500/60 uppercase tracking-[0.2em]">For our Canadians</span>
                                <Lock size={16} className="text-zinc-600" />
                              </div>
                              <div>
                                <h5 className="text-zinc-200 font-serif italic text-xl mb-2">Indigo Collection</h5>
                                <p className="text-[13px] text-zinc-500 leading-relaxed italic font-light">
                                  Curating the best in domestic Canadian literature. Arriving shortly.
                                </p>
                              </div>
                              <div className="mt-2 h-1.5 w-16 bg-zinc-800 rounded-full" />
                            </div>

                            {/* Bookshop - Coming Soon */}
                            <div className="p-10 rounded-[2.5rem] bg-[#1a1625] border border-white/5 flex flex-col gap-6 group relative overflow-hidden shadow-xl">
                              <div className="flex justify-between items-start">
                                <span className="text-[11px] font-black text-purple-500/60 uppercase tracking-[0.2em]">Non-Canadian Friends</span>
                                <Lock size={16} className="text-zinc-600" />
                              </div>
                              <div>
                                <h5 className="text-zinc-200 font-serif italic text-xl mb-2">Bookshop.org Storefront</h5>
                                <p className="text-[13px] text-zinc-500 leading-relaxed italic font-light">
                          ...
                          <p className="text-[10px] text-zinc-600 uppercase tracking-[0.2em] mt-12 text-center italic font-medium">
            ...
            <section className="mb-16">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="bg-gradient-to-br from-[#1a1625] to-[#0A080D] border border-teal-500/30 p-8 rounded-[2.5rem] flex flex-col relative overflow-hidden shadow-2xl">
                  ...
                  <p className="text-[12px] text-zinc-300 font-light italic leading-relaxed mb-10">The primary map for your transition and resignation protocol.</p>
                ...
                <div className="bg-[#16121D] border border-teal-500/10 p-8 rounded-[2.5rem] relative group hover:border-teal-500/30 transition-all flex flex-col shadow-xl overflow-hidden">
                  {!isHearthkeeper && (
                ...
                <div className="bg-[#16121D] border border-purple-500/10 p-8 rounded-[2.5rem] relative group hover:border-purple-500/30 transition-all flex flex-col shadow-xl overflow-hidden">
                  {!isSteward && (
                    <div className="absolute inset-0 z-20 bg-[#0A080D]/95 backdrop-blur-[6px] rounded-[2.5rem] flex flex-col items-center justify-center p-8 text-center">
                      <Lock className="w-5 h-5 text-purple-500/40 mb-3" />
                      <p className="text-[9px] font-black uppercase tracking-[0.2em] text-purple-400/90 mb-5">Steward Required</p>
        ...
        <div className="mt-12 pt-12 border-t border-white/5 flex flex-col items-center gap-8">
          <div className="flex items-center gap-4 p-2 bg-[#16121D] rounded-[2rem] border border-white/5 shadow-2xl">
            <button 
              onClick={() => { setCurrentVolume(1); window.scrollTo({ top: 0, behavior: 'smooth' }); }} 
              className={`px-10 py-4 rounded-[1.5rem] text-[11px] font-black uppercase tracking-[0.15em] transition-all ${currentVolume === 1 ? 'bg-teal-500 text-black shadow-lg shadow-teal-500/20 scale-105' : 'text-zinc-500 hover:text-white hover:bg-white/5'}`}
            >
              Volume I
            </button>
            <button 
              onClick={() => { setCurrentVolume(2); window.scrollTo({ top: 0, behavior: 'smooth' }); }} 
              className={`px-10 py-4 rounded-[1.5rem] text-[11px] font-black uppercase tracking-[0.15em] transition-all ${currentVolume === 2 ? 'bg-teal-500 text-black shadow-lg shadow-teal-500/20 scale-105' : 'text-zinc-500 hover:text-white hover:bg-white/5'}`}
            >
              Volume II
            </button>
          </div>
