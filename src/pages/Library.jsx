      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#110E16]/40 border border-zinc-800 p-6 md:p-8 rounded-2xl md:rounded-[2.5rem] hover:border-purple-500/30 transition-all group flex flex-col">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-[#110E16] to-[#0A080D] border border-teal-500/30 p-8 rounded-2xl md:rounded-[2.5rem] flex flex-col relative overflow-hidden group">
            ...
            <div className="bg-[#110E16]/40 border border-teal-500/10 p-8 rounded-2xl md:rounded-[2.5rem] relative group hover:border-teal-500/30 transition-all flex flex-col">
              {!isHearthkeeper && (
            ...
            <div className="bg-[#110E16]/40 border border-purple-500/10 p-8 rounded-2xl md:rounded-[2.5rem] relative group hover:border-purple-500/30 transition-all flex flex-col">
              {!isSteward && (
                <div className="absolute inset-0 z-20 bg-[#0A080D]/90 backdrop-blur-[6px] rounded-2xl md:rounded-[2.5rem] flex flex-col items-center justify-center p-8 text-center transition-all">
        ...
        <section id="dictionary" className="mb-16 scroll-mt-24">
          ...
          <div className={`bg-[#110E16]/60 border border-teal-500/10 rounded-2xl md:rounded-[2.5rem] p-6 md:p-12 relative ${!isHearthkeeper && 'opacity-40 pointer-events-none'}`}>
        ...
        <section id="architect" className="mb-16 scroll-mt-24 relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start relative">
            {!isSteward && (
                <div className="absolute inset-0 z-30 bg-[#0A080D]/60 backdrop-blur-[12px] rounded-2xl md:rounded-[2.5rem] flex flex-col items-center justify-center text-center p-12 border border-purple-500/20">
            ...
            {/* Input Panel */}
            <div className="space-y-6 bg-[#110E16]/40 border border-purple-500/10 p-6 md:p-10 rounded-2xl md:rounded-[2.5rem]">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <label className="text-[8px] font-black uppercase tracking-widest text-zinc-600">Original Sector</label>
                  <input type="text" value={ml.originSector} className="w-full bg-black/40 border border-zinc-800 p-4 rounded-xl text-[10px] text-white focus:border-purple-500/40 outline-none transition-all" onChange={(e) => setMl({...ml, originSector: e.target.value})} />
                </div>
                <div className="space-y-2">
            ...
            {/* Preview Panel */}
            <div className="bg-white/[0.02] border border-purple-500/10 p-6 md:p-10 rounded-2xl md:rounded-[2.5rem] relative flex flex-col min-h-[400px]">
        ...
        <section id="sanctuary" className="mb-20 pt-10 border-t border-white/5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#110E16]/60 border border-teal-500/10 p-6 md:p-8 rounded-2xl md:rounded-[2.5rem] flex flex-col relative group hover:border-teal-500/30 transition-all">
            ...
            <div className="bg-[#110E16]/40 border border-teal-500/10 p-6 md:p-8 rounded-2xl md:rounded-[2.5rem] hover:border-teal-500/30 transition-all flex flex-col">
