...
import { 
  ...
  Mountain, MessageSquare, Sparkles
} from 'lucide-react';
...
const Library = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0A080D] text-zinc-400 p-4 sm:p-6 md:p-12 font-sans selection:bg-teal-500/30">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <header className="mb-12 md:mb-20 flex flex-col md:flex-row justify-between items-start md:items-end gap-8 border-b border-white/5 pb-10 md:pb-12">
          ...
          <div className="relative w-full md:w-72 group">
            <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-zinc-600 group-focus-within:text-teal-400 transition-colors" />
            <input 
              type="text"
              placeholder="SEARCH RESOURCES..."
              className="w-full bg-[#110E16] border border-zinc-800 rounded-full py-3.5 pl-11 pr-5 text-[9px] font-black tracking-widest text-zinc-200 focus:outline-none focus:border-teal-500/50 uppercase placeholder:text-zinc-800 transition-all"
              value={searchTerm}
        ...
        {/* SECTION 1: THE STUDY (Curated External Lists) */}
        ...
        {/* SECTION 2: THE MASTER PROVISION (The Blueprint) */}
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <Badge className="bg-teal-500/10 text-teal-400 border border-teal-500/20 italic">
                  <Sparkles size={10} className="mr-1.5" /> Blueprint v1.0
                </Badge>
              ...
              <div className="grid grid-cols-1 gap-4">
                {[
                  ...
                  { icon: <Lock size={18} />, label: "Identity Re-Framing", color: "text-zinc-500" }
                ].map((item, i) => (
        ...
        {/* SECTION 3: THE SANCTUARY (Support) */}
        <section id="sanctuary" className="mt-16 border-t border-white/5 pt-16 pb-20 md:pb-32">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            {/* Other cards follow same styling... */}
            <div className="bg-[#110E16]/60 border border-zinc-800 p-8 rounded-[2.5rem] hover:border-teal-500/30 transition-all flex flex-col">
              <div className="w-12 h-12 rounded-xl bg-teal-400/5 text-teal-400 flex items-center justify-center mb-8 border border-teal-400/10">
        ...
        <footer className="pt-12 border-t border-white/5 text-center pb-12">
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-white/[0.02] border border-white/5">
            <ShoppingBag className="w-3 h-3 text-zinc-700" />
            <span className="text-[8px] font-medium uppercase tracking-[0.2em] text-zinc-700 italic">Affiliate Reciprocity: We only recommend tools that provide genuine leverage.</span>
          </div>
        </footer>
      </div>
    </div>
