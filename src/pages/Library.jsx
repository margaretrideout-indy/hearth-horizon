  ...
  return (
    <div className="min-h-screen bg-[#0F0A15] text-slate-300 p-6 md:p-12 font-sans selection:bg-teal-500/30">
      <div className="max-w-6xl mx-auto">
        ...
        {/* SECTION 1: THE STUDY (AFFILIATE LINKS TOP PRIORITY) */}
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <button className="h-16 px-10 bg-teal-600 hover:bg-teal-500 text-black font-black rounded-2xl flex items-center justify-center gap-3 transition-all shadow-lg shadow-teal-500/10 uppercase tracking-widest text-[11px]">
                    Download Provisions <FileDown size={18} />
                  </button>
                  <button className="h-16 px-10 bg-white/5 border border-white/10 text-white font-black rounded-2xl flex items-center justify-center gap-3 hover:bg-white/10 transition-all uppercase tracking-widest text-[11px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-32">
          ...
          <section className="space-y-8">
            ...
            <div className="bg-white/[0.01] border border-white/5 p-8 rounded-[2.5rem] hover:bg-white/[0.03] transition-all group">
              ...
              <p className="text-[10px] text-slate-500 font-light leading-relaxed mb-6 italic">Translate legacy experience into high-impact corporate operations value.</p>
              <button 
        ...
        <section className="mt-20 border-t border-white/5 pt-20 pb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#1A1423] border border-white/5 p-8 rounded-[2.5rem] flex flex-col relative group">
              ...
              <p className="text-[10px] text-slate-500 font-light font-sans leading-relaxed mb-8 italic">Nationwide support and tools for managing mental health during life shifts.</p>
              <div className="mt-auto space-y-4">
                <a href="https://cmha.ca/find-help/" target="_blank" rel="noopener noreferrer" className="text-[9px] font-black uppercase tracking-widest text-teal-400 hover:text-white transition-colors flex items-center gap-2 group/link">
                  ACCESS CMHA HELP <ArrowRight className="w-3 h-3 transition-transform group-hover/link:translate-x-1" />
                </a>
              </div>
            </div>
