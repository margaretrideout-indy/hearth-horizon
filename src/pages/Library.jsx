      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <header className="mb-16 border-b border-white/5 pb-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          <div className="space-y-4">
            ...
            <p className="text-[10px] text-zinc-500 font-black uppercase tracking-[0.3em] italic">Sanctuary, Basecamp & The Lookout</p>
          </div>
        ...
        <div className="mt-12 pt-12 border-t border-white/5 flex flex-col items-center gap-6">
          ...
          <div className="flex gap-4 p-2 bg-[#16121D] rounded-3xl border border-white/10 shadow-2xl">
            <button onClick={() => setCurrentVolume(1)} className={`px-10 py-4 rounded-2xl text-[11px] font-black uppercase transition-all ${currentVolume === 1 ? 'bg-teal-500 text-black shadow-lg' : 'text-zinc-500 hover:text-white'}`}>Volume I: Basecamp</button>
            <button onClick={() => setCurrentVolume(2)} className={`px-10 py-4 rounded-2xl text-[11px] font-black uppercase transition-all ${currentVolume === 2 ? 'bg-teal-500 text-black shadow-lg' : 'text-zinc-500 hover:text-white'}`}>Volume II: Trail Kit</button>
          </div>
        </div>
