...
export default function Hearth({ userData, onSync }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-8 pt-12 pb-20 font-sans">
      {/* HEADER BANNER */}
      <div className="rounded-3xl bg-gradient-to-r from-[#1A2E2C] to-[#141B1A] border border-white/10 p-12 mb-10 shadow-2xl">
        <div className="flex justify-between items-start">
          <div className="space-y-2">
            <h3 className="text-xs font-black tracking-[0.3em] text-gray-500 uppercase">SANCTUARY</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          ...
          <Card className="p-8 bg-[#1C1622]/40 border-white/5">
            <div className="flex justify-between items-center mb-10">
              <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest">TRACK: {userData.journey}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="p-8 bg-[#1C1622]/40 border-white/5 flex flex-col items-center justify-center text-center space-y-4 min-h-[220px]">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-gray-600 italic">Upload resume for synthesis</p>
                </div>
                <input type="file" id="resume-up" className="hidden" onChange={handleUpload} />
                <Button asChild variant="outline" className="text-[9px] font-black uppercase border-white/10 h-8 cursor-pointer hover:bg-white/5">
                  <label htmlFor="resume-up">{userData.isAligned ? "Synced" : "Select PDF"}</label>
                </Button>
              </Card>

              <Card className="p-6 bg-[#1C1622]/40 border-white/5 space-y-4">
                <p className="text-[10px] font-black uppercase text-gray-500">Pulse Check</p>
                <Textarea 
                  placeholder="Record today's reflection..."
                ...
                />
                <Button className="h-7 text-[9px] font-black uppercase bg-white/5 hover:bg-white/10 border border-white/5 px-4">Bank Note</Button>
              </Card>
            </div>
          </div>
        </div>
        ...
        {/* SIDEBAR */}
        <div className="p-8 bg-[#1C1622]/40 border-white/5 rounded-2xl self-start space-y-6">
          <p className="text-[10px] font-black uppercase text-gray-500 tracking-widest">Maturing Status</p>
          <p className="text-xs text-gray-500 italic leading-relaxed">
            Upload your resume to activate the Mycelium network.
          </p>
