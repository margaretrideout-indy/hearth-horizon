...
export default function Hearth({ userData, onSync }) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-8 pt-12 space-y-10 pb-20">
      {/* HEADER SECTION */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="grid grid-cols-4 gap-4">
              {['Discovery', 'Translation', 'Bridging', 'Launching'].map((s, i) => (
                <div key={s} className="flex flex-col items-center gap-3">
                  ...
                  <span className={`text-[10px] font-black uppercase ${i === 0 ? 'text-white' : 'text-gray-600'}`}>{s}</span>
                </div>
              ))}
            </div>
          </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="p-8 bg-[#1C1622]/40 border-white/5 flex flex-col items-center justify-center text-center space-y-4 min-h-[220px]">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-gray-600 italic">Sync your resume</p>
                </div>
                ...
                <Button asChild variant="outline" className="text-[9px] font-black uppercase border-white/10 h-8 cursor-pointer hover:bg-white/5">
                  <label htmlFor="h-up">{userData.isAligned ? "File Synced" : "Upload Resume"}</label>
                </Button>
              </Card>
              ...
              <Card className="p-6 bg-[#1C1622]/40 border-white/5 space-y-4">
                ...
                <Textarea 
                  placeholder="Record your pulse check..."
                ...
                />
                <Button className="h-7 text-[9px] font-black uppercase bg-white/5 hover:bg-white/10 border border-white/5 px-4">Save Pulse</Button>
              </Card>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-8">
          <Card className="p-8 bg-[#1C1622]/40 border-white/5 space-y-6">
            <p className="text-[10px] font-black uppercase text-gray-500 tracking-widest italic">Growth status</p>
            <p className="text-xs text-gray-500 italic leading-relaxed">
              Sync your first file to activate the map.
            </p>
