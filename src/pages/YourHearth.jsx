      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-[#1A2E2C] to-[#141B1A] border border-white/10 p-12 shadow-2xl">
        <div className="relative z-10 flex justify-between items-start">
          <div className="space-y-2">
            <h3 className="text-xs font-black tracking-[0.3em] text-gray-500 uppercase">YOUR HEARTH</h3>
            <h1 className="text-5xl font-bold text-white tracking-tight">
              Welcome home, <span className="text-teal-400">{userData.name}.</span>
            </h1>
            <p className="text-lg text-gray-400 italic">Your horizon is waiting.</p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          ...
          <Card className="p-8 bg-[#1C1622]/40 border-white/5">
            <div className="flex justify-between items-center mb-10">
              <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest">PATH: {userData.journey}</p>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card className="p-8 bg-[#1C1622]/40 border-white/5 flex flex-col items-center justify-center text-center space-y-4 min-h-[220px]">
                ...
                <Button asChild variant="outline" className="text-[9px] font-black uppercase border-white/10 h-8 cursor-pointer">
                  <label htmlFor="h-up">{userData.isAligned ? "Aligned" : "Select File"}</label>
                </Button>
              </Card>

              {/* PULSE CHECK */}
              <Card className="p-6 bg-[#1C1622]/40 border-white/5 space-y-4">
                <p className="text-[10px] font-black uppercase text-gray-500">Reflection</p>
                <Textarea 
                ...
                />
                <Button className="h-7 text-[9px] font-black uppercase bg-white/5 border border-white/5">Submit</Button>
              </Card>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-8">
          <Card className="p-8 bg-[#1C1622]/40 border-white/5 space-y-6">
            <p className="text-[10px] font-black uppercase text-gray-500 tracking-widest italic">Ecosystem Status</p>
            <p className="text-xs text-gray-500 italic leading-relaxed">Maturing: 0% Complete</p>
