...
const PathfinderProtocol = ({ vault, pulses }) => {
  ...
  // Logic-driven completion: These are now automatic based on user actions
  ...
  const milestones = [
    { 
      ...
      description: "Optional: Uploading your resume allows the ecosystem to offer more personalized alignment." 
    },
    { 
      id: 'checkin', 
      icon: Compass, 
      ...
      description: "Invitation: Documenting your daily weather helps map your internal trajectory." 
    },
    { 
      id: 'alignment', 
      icon: Map, 
      ...
      description: "Exploration: Visit Ecosystem Alignment to see how your values sync with the horizon." 
    },
    { 
      id: 'canopy', 
      icon: Trees, 
      isCompleted: false, 
      title: "Take Flight", 
      description: "Vision: Survey the pathways in The Canopy whenever you feel ready for a higher view." 
    },
    { 
      id: 'embers', 
      icon: Flame, 
      ...
      description: "Community: Embers Chat is always here if you crave reciprocity, but it is never mandatory." 
    }
  ];
...
// --- Existing Constellation Component ---
    ...
    <div className="min-h-screen bg-[#0F0A15] text-white font-sans selection:bg-teal-500/30 pb-20">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <header className="mb-12">
          ...
          {/* New Pathfinder Protocol Integrated Here */}
