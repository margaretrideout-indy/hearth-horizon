...
const TierBadge = () => {
  return (
    <div style={{
      ...
      border: '1px solid rgba(20, 184, 166, 0.2)', marginTop: '20px'
    }}>
...
const Dashboard = ({ user }) => (
  <div style={{ padding: '40px 20px', maxWidth: '1000px', margin: '0 auto' }}>
    <div style={{
      ...
      <h1 style={{ fontSize: '4.5rem', margin: '0 0 10px 0', fontWeight: '900', letterSpacing: '-0.04em', lineHeight: '1' }}>
    ...
    <div style={{ 
      background: 'rgba(255, 255, 255, 0.02)', padding: '40px', borderRadius: '30px', 
      border: '1px solid rgba(255, 255, 255, 0.05)', textAlign: 'left' 
    }}>
      <p style={{ color: '#14b8a6', fontSize: '0.9rem', fontWeight: '800', marginBottom: '10px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
        Ready for your next crossing?
      </p>
      <p style={{ color: '#94a3b8', fontSize: '1rem', margin: '0 0 20px 0', lineHeight: '1.6' }}>
        Upload your CV to <b>The Bridge Builder</b>. We'll translate your educational leadership into tech-sector data narratives.
      </p>
      <button style={{ 
        background: '#14b8a6', color: '#020617', border: 'none', padding: '14px 32px', 
  ...
  <div style={{ padding: '40px 20px', maxWidth: '1000px', margin: '0 auto' }}>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '20px' }}>
      {[
        ...
        <div key={i} style={{ 
          background: 'rgba(255,255,255,0.02)', padding: '30px', borderRadius: '25px', 
          border: '1px solid rgba(255,255,255,0.05)', textAlign: 'left'
        }}>
...
export default function App() {
  ...
  const navStyle = {
    display: 'flex', gap: '30px', padding: '25px 50px', background: '#020617',
