...
const TierBadge = () => (
  <div style={{
    ...
    background: 'rgba(255, 255, 255, 0.03)', borderRadius: '16px', border: '1px solid rgba(45, 212, 191, 0.2)', marginTop: '20px'
  }}>
...
const Dashboard = ({ user }) => (
  <div style={{ padding: '40px 20px', maxWidth: '1000px', margin: '0 auto' }}>
    ...
    <div style={{ background: 'rgba(255, 255, 255, 0.03)', padding: '40px', borderRadius: '35px', border: '1px solid rgba(255, 255, 255, 0.05)', textAlign: 'left' }}>
      ...
      <button style={{ 
        background: '#14b8a6', color: '#1e1b24', border: 'none', padding: '16px 36px', 
  ...
  <div style={{ padding: '40px 20px', maxWidth: '1000px', margin: '0 auto' }}>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '20px' }}>
      {['Teacher-to-Tech Dictionary', 'Linguistic Bridge Guide'].map((title, i) => (
        <div key={i} style={{ background: 'rgba(255, 255, 255, 0.03)', padding: '30px', borderRadius: '30px', border: '1px solid rgba(255, 255, 255, 0.05)', textAlign: 'left' }}>
...
export default function App() {
  ...
  const navStyle = {
    display: 'flex', gap: '40px', padding: '30px 60px', background: '#1e1b24',
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#1e1b24', color: 'white', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      <nav style={navStyle}>
